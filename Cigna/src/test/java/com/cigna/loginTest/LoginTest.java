...
public class LoginTest extends TestBase {
    ...
    public void usersCanValidateCredentialTest(String username, String password){
    ...
    public void usersCanValidateCredentialErrorMessageTest(String username, String password){
        LoginPage loginPage = PageFactory.initElements(driver,LoginPage.class);
        loginPage.clickOnLoginButton();
        ExtentTestManager.log("User in home page for click on login button",logger);
        handleNewTab(driver);
